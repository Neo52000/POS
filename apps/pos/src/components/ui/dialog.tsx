    ...
    >
      ...
      {!hideClose && (
        <DialogPrimitive.Close
          className="absolute right-3 top-3 flex h-12 w-12 items-center justify-center rounded-xl text-muted hover:bg-border hover:text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
          aria-label="Fermer"
        >
          <X className="h-6 w-6" />
        </DialogPrimitive.Close>
